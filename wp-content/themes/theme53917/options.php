...
// ---------------------------------------------------------
			...
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '50px', 'lineheight' => '60px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#323232'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '42px', 'lineheight' => '56px', 'face' => 'Raleway', 'style' => 'bold', 'character'  => 'latin', 'color' => '#323232'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '36px', 'lineheight' => '47px', 'face' => 'Raleway', 'style' => 'bold', 'character'  => 'latin', 'color' => '#323232'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '39px', 'face' => 'Raleway', 'style' => 'bold', 'character'  => 'latin', 'color' => '#323232'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '25px', 'lineheight' => '33px', 'face' => 'Raleway', 'style' => 'bold', 'character'  => 'latin', 'color' => '#323232'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '26px', 'face' => 'Raleway', 'style' => 'bold', 'character'  => 'latin', 'color' => '#323232'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '16px', 'lineheight' => '22px', 'face' => 'Raleway', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
<h1>I\'m a professional photographer 
delivering artistically 
styled stunning images!</h1>

[button text="My Resume" link="#" style="default" size="normal" target="_self" display="inline" icon="cloud"] [button text="Learn more" link="#" style="default" size="normal" target="_self" class="clean" display="inline" icon="no"]
