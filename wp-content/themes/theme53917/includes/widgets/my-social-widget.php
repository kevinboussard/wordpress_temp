...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php foreach(array("Facebook", "Twitter", "Flickr", "Pinterest", "Rss", "Delicious", "Linkedin", "Google_plus") as $network) : ?>
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'twitter' => '', 'twitter_label' => '', 'facebook' => '', 'facebook_label' => '', 'flickr' => '', 'flickr_label' => '', 'pinterest' => '', 'pinterest_label' => '', 'rss' => '', 'rss_label' => '', 'delicious' => '', 'delicious_label' => '', 'linkedin' => '', 'linkedin_label' => '', 'google_plus' => '', 'google_plus_label' => '', 'display' => 'icons', 'text' => '');
...
?>
	...
	<p><label for="<?php echo $this->get_field_id('pinterest'); ?>"><?php echo 'Pinterest:' ?></label>
