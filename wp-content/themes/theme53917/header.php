	...
	<script type="text/javascript">
		jQuery(document).ready(function(){
			if(!device.mobile() && !device.tablet()){
				...
				,	active: <?php echo (of_get_option('stickup_menu', 'true')=="false") ? 'false' : 'true'; ?>
...
<body <?php body_class(); ?>>
	<div id="motopress-main" class="main-holder">
		...
		<div class="offer-wrap <?php if (of_get_option('offer_display_id') == 'true'): ?>only-on-main-page<?php endif ?>">
			<div class="container">
				<div class="row">
					<div class="span12" data-motopress-type="static" data-motopress-static-file="static/static-offer.php">
						<?php get_template_part("static/static-offer"); ?>
					</div>
				</div>
			</div>
		</div>		
