...
function connexions_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'connexions_lite_intagram_link', array(
		'default'        => '#',
		'sanitize_callback' => 'esc_url_raw',
	));
	$wp_customize->add_control('connexions_lite_intagram_link', array(
		'label' => __('Intagram Link', 'connexions-lite'),
